...
//         if (!global.targetManager[room.name]) {
//             global.targetManager[room.name] = new TargetManager(room);
//         }
...
//     private rebuild(room: Room) {
//         Logger.log(`Rebuilding target queue for ${room.name}`, INFO)
//         //Rebuild the TargetManager for the room from creep memory.
//     }
